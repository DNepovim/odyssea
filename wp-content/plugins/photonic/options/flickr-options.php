...
$photonic_flickr_options = array(
	...
	array("name" => "Main image size",
		...
		"options" => array(
			...
			"c" => "Medium, 800px on longest side (not always available)",
			"b" => "Large, 1024px on longest side (not always available)",
			"h" => "Large, 1600px on longest side (not always available)",
			"o" => "Original (not always available)",
		),
		"std" => "z"),
	...
	array("name" => "Photoset Thumbnails (with other Photosets)",
	...
	array("name" => "Photoset Headers (Standalone Photosets)",
