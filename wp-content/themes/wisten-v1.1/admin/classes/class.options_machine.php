		...
		foreach ($options as $value) {
			...
			switch ( $value['type'] ) {
				...
				case 'typography':
					...
					if(isset($typography_stored['face'])) {
						...
						$faces = array('arial'=>'Arial',
										...
										'palatino'=>'Palatino',
										'helvetica'=>'Helvetica' );		
						/* Clapat custom code. Do not remove */
						$faces = apply_filters('clapat_add_google_fonts', $faces);
				...
				case 'backup':
					...
					$output .= '<p><strong>'. __('Last Backup : ' ,'fastwp').'<span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
